<?=template_header('Thêm order')?>

<body>
    <main class="container mt-5 mb-5">
        <div class="row">
            <div class="col-sm">
                <h3 class="text-center text-uppercase fw-bold title_create">Thêm order</h3>
                <form class="form_create" action="index.php?controller=order&action=store" method="post">
