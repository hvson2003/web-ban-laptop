                        ...
                        <div class="panel-body">
                            ...
                            <form method="POST" enctype="multipart/form-data" class="panel-body form-horizontal form-padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="name" class="form-control" placeholder="Tên danh mục" required minlength="4" maxlength="255" <?php if(isset($_POST['name'])) echo 'value="'.$_POST['name'].'"' ?>>
                                    </div>
                                </div>
                                <!--Textarea-->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea required name="cate_desc" rows="5" class="form-control" placeholder="Nhập nội dung mô tả.."><?php if(isset($_POST['cate_desc'])) echo $_POST['cate_desc'];?></textarea>
                                    </div>
                                </div>
                                <!-- upload image -->
                                <div class="form-group">
                                ...
                                <div class="panel-footer">
                                    <div class="row">
                                        <div class="col-sm-9 col-sm-offset-3">
                                            <button class="btn btn-mint" type="submit">Thêm danh mục</button>
