				...
				<div class="col-lg-12">
			        <div class="panel">
                        ...
                        <div class="alert alert-success">
                          ...
                          Thêm màu sản phẩm thành công ! <a href="admin.php?task=listcolor">Xem</a>
                        </div>
                        <?php } elseif(isset($ketqua)&&!$ketqua) { ?>
                          <div class="alert alert-danger">
                            <button class="close" data-dismiss="alert"><i class="pci-cross pci-circle"></i></button>
                            Thêm màu sản phẩm thất bại !
                          </div>
                        <?php } ?>
                        ...
                        <div class="panel-body">
                            ...
                            <form method="POST" class="panel-body form-horizontal form-padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="name" class="form-control" placeholder="Tên của màu sắc sản phẩm" required minlength="3" maxlength="255" <?php if(isset($_POST['name'])) echo 'value="'.$_POST['name'].'"' ?>>
                                    </div>
                                </div>
                                <!--Text Input-->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="color-picker" name="value" class="form-control" placeholder="mã màu sắc" required minlength="1" maxlength="255" <?php if(isset($_POST['value'])) echo 'value="'.$_POST['value'].'"' ?>>
                                    </div>
                                </div>
                                <div class="panel-footer">
                                    <div class="row">
                                        <div class="col-sm-9 col-sm-offset-3">
                                            <button class="btn btn-mint" type="submit">Thêm màu sắc</button>
