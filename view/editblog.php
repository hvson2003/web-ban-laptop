				...
				<div class="col-lg-12">
			        <div class="panel">
                        ...
                        <div class="alert alert-success">
                          ...
                          Sửa bài viết thành công ! <a href="admin.php?task=listblog">Xem</a>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <form method="POST" enctype="multipart/form-data" class="panel-body form-horizontal form-padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="title" class="form-control" placeholder="Tên bài viết" required minlength="4" maxlength="500" value="<?php echo $blog['title'] ?>">
                                    </div>
                                </div>
                                 <!--Textarea-->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea required name="blog_desc" rows="3" class="form-control" placeholder="Nhập nội dung mô tả.."><?php echo $blog['blog_desc'] ?></textarea>
                                    </div>
                                </div>
                                <!--Textarea-->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea id="summernote" required name="content" rows="5" class="form-control" placeholder="Nhập nội dung bài viết"><?php echo $blog['content'] ?></textarea>
                                    </div>
                                </div>
                                <!-- upload image -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group mar-btm">
                                            <input type="text" name="thumbnail" id="linkf" placeholder="Điền đường dẫn ảnh" required class="form-control" value="<?php echo $blog['thumbnail'] ?>">
                                            <span class="input-group-btn">
                                        ...
                                        <div id="uploaded_image">
                                            <img src="<?php echo $blog['thumbnail'] ?>" width="300px" height="250px" class="mw-100 img-thumbnail"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-footer">
                                    <div class="row">
                                        <div class="col-sm-9 col-sm-offset-3">
                                            <button class="btn btn-mint" type="submit">Sửa bài viết</button>
