				...
				<div class="col-lg-12">
			        <div class="panel">
                        ...
                        <div class="alert alert-success">
                          ...
                          Thay đổi cấu hình thành công ! <a href="admin.php?task=listconfig">Xem</a>
                        </div>
                        <?php } elseif(isset($ketqua)&&!$ketqua) { ?>
                          <div class="alert alert-danger">
                            <button class="close" data-dismiss="alert"><i class="pci-cross pci-circle"></i></button>
                            Thay đổi cấu hình thất bại !
                          </div>
                        <?php } ?>
                        ...
                        <div class="panel-body">
                            ...
                            <form method="POST" class="panel-body form-horizontal form-padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <b><?php echo $config['config_key'] ?></b>
                                    </div>
                                </div>
                                <!--Textarea-->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" required name="config_desc" cols="30" rows="5"><?php echo $config['config_desc'] ?></textarea>
                                    </div>
                                </div>
                                <!-- input -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="config_value" required class="form-control" value="<?php echo $config['config_value'] ?>">
                                    </div>
                                </div>
                                <div class="panel-footer">
                                    <div class="row">
                                        <div class="col-sm-9 col-sm-offset-3">
                                            <button class="btn btn-warning" type="submit">Sửa cấu hình</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
