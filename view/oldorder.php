<?php require_once('header_quanly.php'); ?> 
    <div id="content-container">
        <div id="page-head">
            ...
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <div id="page-title">
                <h1 class="page-header text-overflow">Quản Lý / Hóa Đơn Đã Duyệt</h1>
                    ...
                    <table id="dtable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="admin.php?task=detailorder&id=<?php echo $hd['id'] ?>" class="btn btn-warning">Xem chi tiết</a>
